...
module.exports = function(environment) {
  var ENV = {
    ...
    contentSecurityPolicy: {
      'default-src': "'none'",
      'script-src': "'self' 'unsafe-inline' 'unsafe-eval' dev.app.dnt.privat:49152 hytte.app.dnt.privat:49152 hytte.app.dnt.privat dev.app.dnt.no use.typekit.net connect.facebook.net maps.googleapis.com maps.gstatic.com cdn.ravenjs.com",
